...
function Chatbot() {
  ...
  // const handleDivClick = (content) => {
  //   setGeneratedMaterial(JSON.stringify(content, null, 2));
  // };
  ...
  return (
    <section className="p-5 min-h-screen bg-background flex flex-col justify-center items-center">
      <div className="relative py-10 rounded-lg shadow-lg w-full max-w-5xl cursor-pointer">
        ...
        <div className="flex flex-col items-center justify-center w-full px-28">
          ...
          <div
            className="grid grid-cols-4 gap-4 py-5 px-3 flex-grow"
            style={{
              overflowY: "auto",
          ...
          >
            {generatedContent?.map((content, i) => (
              <div
                key={i}
                className="relative p-8 rounded-lg shadow-lg w-full max-w-2xl cursor-pointer"
