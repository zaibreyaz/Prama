        ...
        <form>
            <div className="mb-4">
                ...
                <input
                    ...
                    id="email"
                    className=" text-white w-full px-4 py-2 border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    id="password"
                    className="w-full text-white px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 bg-background focus:ring-blue-500"
